...
WebUI.sendKeys(findTestObject('Interview-No button/Page_StandbyMD Directional Care/input_DOB_DOB'), '12121988')
...
WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/label_Greater than 104 F or 40 C'))

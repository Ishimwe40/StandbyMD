...
WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/label_Between 1004 and 104 F or 38 and 40 C'))

WebUI.click(findTestObject('Page_StandbyMD Directional Care/label_No'))

WebUI.click(findTestObject('Page_StandbyMD Directional Care/label_No'))

WebUI.click(findTestObject('Page_StandbyMD Directional Care/label_Mild'))

WebUI.click(findTestObject('Page_StandbyMD Directional Care/label_Less than 3 months'))

WebUI.click(findTestObject('Page_StandbyMD Directional Care/label_All over'))

...
WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/label_Upper right'))

WebUI.click(findTestObject('Page_StandbyMD Directional Care/button_Next_1_2_3_4'))

WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/label_Over 2 weeks'))

WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/label_Over 8 hours'))
...
WebUI.setText(findTestObject('Page_StandbyMD Directional Care/input_Claim_LinkClaimNumber'), '1234534')
...
WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/label_Less than 2 days'))

WebUI.click(findTestObject('Page_StandbyMD Directional Care/label_Less than 30 minutes'))

...
WebUI.click(findTestObject('Page_StandbyMD Directional Care/div_Stomach pain'))
...
WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/label_For more than 4 weeks'))

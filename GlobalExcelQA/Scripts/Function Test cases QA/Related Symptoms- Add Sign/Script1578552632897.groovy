...
WebUI.click(findTestObject('Coordinate-Submit request/Page_StandbyMD Directional Care/input_DOB_DOB'))

WebUI.sendKeys(findTestObject('Page_StandbyMD Directional Care/input_DOB_DOB'), '12121988')

WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/div_Age_col-sm-4'))

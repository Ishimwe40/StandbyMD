...
WebUI.doubleClick(findTestObject('Page_Sign in to your account/button_Sign in'))

WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/div_Yes'))

...
WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/i__fas fa-2x fa-exclamation-circle'))

WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/i__fas fa-2x fa-exclamation-circle'))

WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/i_Contacts_fas fa-plus-circle'))

WebUI.scrollToElement(findTestObject('Page_StandbyMD Directional Care/button_Close'), 2)

WebUI.delay(5)

WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/button_Close'))

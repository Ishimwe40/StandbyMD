...
WebUI.click(findTestObject('Page_StandbyMD Directional Care/i__fas fa-2x fa-phone-slash'))

WebUI.selectOptionByValue(findTestObject('Page_StandbyMD Directional Care/select_Call was interruptedEmergency situat_490c73'), 
    '13', true)

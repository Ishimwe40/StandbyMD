...
WebUI.click(findTestObject('Page_StandbyMD Directional Care/i__fas fa-2x fa-exclamation-circle'))

WebUI.click(findTestObject('Page_StandbyMD Directional Care/i__fas fa-2x fa-exclamation-circle'))

WebUI.click(findTestObject('Page_StandbyMD Directional Care/i_Contacts_fas fa-plus-circle'))

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_StandbyMD Directional Care/select_PatientNonPatient'), 
    '1', true)

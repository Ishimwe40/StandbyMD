...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_StandbyMD Directional Care/select_LloydsManulifeOrionOtherSTARR  Canad_580e10'), 
    '13', true)

WebUI.selectOptionByValue(findTestObject('Page_StandbyMD Directional Care/select_21st Century     Aeroplan         Ai_17f4f0'), 
    '28', true)

WebUI.setText(findTestObject('Page_StandbyMD Directional Care/input_Policy _Policy'), '5')

WebUI.setText(findTestObject('Page_StandbyMD Directional Care/input_Case _ClaimRef'), '8')
...
WebUI.click(findTestObject('Page_StandbyMD Directional Care/div_Nonmenstrual vaginal bleeding or spotting'))
...
WebUI.click(findTestObject('Page_StandbyMD Directional Care/label_Upper right'))

WebUI.click(findTestObject('Page_StandbyMD Directional Care/label_Lower right'))

WebUI.click(findTestObject('Page_StandbyMD Directional Care/button_Next_1_2_3_4'))

WebUI.click(findTestObject('Page_StandbyMD Directional Care/label_Less than 2 days'))

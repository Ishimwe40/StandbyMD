...
WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/div_Recent childbirth'))
...
WebUI.click(findTestObject('Interview-No button/Page_StandbyMD Directional Care/button_Next_1'))

WebUI.setText(findTestObject('Object Repository/Page_StandbyMD Directional Care/textarea_Describe the members symptoms or p_874eed'), 
    'Headache\nFever')
...
WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/label_Between 1004 and 104 F (38 and 40 C)'))

WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/button_Back'))

...
WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/html_gm-style gm-style-mtc labelgm-style gm_6b9fbd'))

WebUI.click(findTestObject('Page_StandbyMD Directional Care/button_Next_1'))

WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/a_Present (2)'))

WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/a_Absent (0)'))

WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/a_Reported'))

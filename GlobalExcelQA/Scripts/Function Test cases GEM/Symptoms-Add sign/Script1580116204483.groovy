...
WebUI.click(findTestObject('Page_StandbyMD Directional Care/div_Runny nose'))

WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/div_Shortness of breath'))

WebUI.click(findTestObject('Page_StandbyMD Directional Care/div_Skin changes'))

WebUI.click(findTestObject('Page_StandbyMD Directional Care/div_Sore throat'))

WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/div_Stomach pain'))

WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/div_Vomiting'))

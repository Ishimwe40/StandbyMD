...
WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/div_Symptom Selector'))
...
WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/button_No'))

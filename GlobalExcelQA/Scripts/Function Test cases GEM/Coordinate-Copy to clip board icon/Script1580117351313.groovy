...
WebUI.click(findTestObject('Page_StandbyMD Directional Care/span_Hospital And Shelter Dyouville'))

WebUI.click(findTestObject('Page_StandbyMD Directional Care/button_Next_1'))

WebUI.setText(findTestObject('Page_StandbyMD Directional Care/input_Claim_LinkClaimNumber'), '1234543')
...
WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/i_Coordinate Summary_far fa-clipboard fa-2x'))

...
WebUI.click(findTestObject('Symptoms-No button when select one symptom/Page_Choose your account/button_Client Sign-in'))
...
WebUI.setText(findTestObject('Page_StandbyMD Directional Care/input_Symptoms_Symptoms'), 'headache')

WebUI.sendKeys(findTestObject('Page_StandbyMD Directional Care/input_Symptoms_Symptoms'), Keys.chord(Keys.ENTER))

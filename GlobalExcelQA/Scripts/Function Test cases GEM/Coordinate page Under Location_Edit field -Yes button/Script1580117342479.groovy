...
WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/i_Distance_far fa-edit'))

WebUI.setText(findTestObject('Object Repository/Page_StandbyMD Directional Care/input_Distance_Address'), 'kigali')

WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/i_Distance_far fa-check-square'))

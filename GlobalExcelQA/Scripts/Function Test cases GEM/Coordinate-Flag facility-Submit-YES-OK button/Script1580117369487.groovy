...
WebUI.click(findTestObject('Page_StandbyMD Directional Care/i_concat(Hospital And Shelter D  youville)__9bdb14'))

WebUI.selectOptionByValue(findTestObject('Page_StandbyMD Directional Care/select_Incorrect AddressIncorrect HoursInco_e9a202'), 
    '3', true)

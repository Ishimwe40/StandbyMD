...
WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/a_Contact'))

WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/a_Summary'))

...
WebUI.click(findTestObject('Page_StandbyMD Directional Care/span_1036 Rue Belvdre S Sherbrooke QC J1H 4_c65675'))
...
WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/i_Coordinate Summary_fas fa-sync-alt fa-2x'))

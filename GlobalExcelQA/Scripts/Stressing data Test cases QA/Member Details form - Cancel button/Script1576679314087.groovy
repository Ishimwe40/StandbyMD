...
WebUI.setText(findTestObject('Page_StandbyMD Directional Care/input_Member_Member'), 'efregrt4565688')
...
WebUI.setText(findTestObject('Page_StandbyMD Directional Care/input_Policy _Policy'), 'etrr56556')

WebUI.setText(findTestObject('Page_StandbyMD Directional Care/input_Case _ClaimRef'), 'sfergrt45657686')

WebUI.setText(findTestObject('Page_StandbyMD Directional Care/input_Phone_Phone'), 'sfertr5657')

WebUI.setText(findTestObject('Page_StandbyMD Directional Care/input_Email_Email'), 'fdgfr5y676787jFHFGH')

WebUI.delay(5)

WebUI.click(findTestObject('Page_StandbyMD Directional Care/button_Cancel'))

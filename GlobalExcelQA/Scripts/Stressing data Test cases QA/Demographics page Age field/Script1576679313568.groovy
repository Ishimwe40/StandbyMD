...
WebUI.setText(findTestObject('Page_StandbyMD Directional Care/input_Member_Member'), 'dfgfgrty6y')
...
WebUI.setText(findTestObject('Page_StandbyMD Directional Care/input_Policy _Policy'), 'dfgftr656')

WebUI.setText(findTestObject('Page_StandbyMD Directional Care/input_Case _ClaimRef'), '123456fgfdg')

WebUI.setText(findTestObject('Page_StandbyMD Directional Care/input_Phone_Phone'), '12345!@#$%%')

WebUI.setText(findTestObject('Page_StandbyMD Directional Care/input_Email_Email'), 'fdssrdt5r6568@com')

WebUI.click(findTestObject('Page_StandbyMD Directional Care/button_Save'))

WebUI.delay(5)

WebUI.sendKeys(findTestObject('Page_StandbyMD Directional Care/input_DOB_DOB'), '12122012')

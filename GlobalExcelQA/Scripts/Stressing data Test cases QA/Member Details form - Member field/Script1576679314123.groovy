...
WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/i_Spanish_userTag'))

WebUI.setText(findTestObject('Page_StandbyMD Directional Care/input_Member_Member'), 'eertry56766666666665')

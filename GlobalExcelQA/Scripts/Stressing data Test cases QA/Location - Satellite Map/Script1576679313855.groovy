...
WebUI.sendKeys(findTestObject('Page_StandbyMD Directional Care/input_DOB_DOB'), '12122003')
...
WebUI.click(findTestObject('Page_StandbyMD Directional Care/div_Satellite'))

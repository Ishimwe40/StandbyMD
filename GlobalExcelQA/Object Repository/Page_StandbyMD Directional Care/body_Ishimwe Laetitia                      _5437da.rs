...
<WebElementEntity>
   ...
   <name>body_Ishimwe Laetitia                      _5437da</name>
   <tag></tag>
   <elementGuidId>dc00ecbd-aaef-4d0f-92b0-34c898493499</elementGuidId>
   <selectorCollection>
      <entry>
         <key>XPATH</key>
         <value>//body</value>
   ...
   <webElementProperties>
    ...
    .dropdown:hover .dropbtn {
        ...
        Member: #: LaetitiaOrganization: TestSub Org: TestPolicy #: 12345Case #: 123456
...
/*Menu Patient */
    ...
    $(document).ready(function() {
        LoadContacts('');
            ...
            +
            Pain when pressing abdomen in lower part
            ...
            +
            Reddish purple rash on the skin around the eyes
            ...
            +
            Repetition of another person's actions or words
            ...
            +
            Smaller mouth, difficulty opening mouth
            ...
            +
            Stomach pain after caffeinated drinks
            ...
            +
            Stomach pain in right upper side
            ...
            +
            Swallowed food coming back up into the mouth
...
Test
    ...
    $(document).ready(function () {
        ...
        UpdateScreenResolution('27912', $height, $width);

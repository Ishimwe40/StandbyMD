...
<WebElementEntity>
   ...
   <name>body_Ishimwe Laetitia                      _7ed513_1</name>
   <tag></tag>
   <elementGuidId>52a006a6-37f5-42d9-9419-6be22902cafa</elementGuidId>
   <selectorCollection>
      <entry>
         <key>XPATH</key>
         <value>//body</value>
...
/*Menu Patient */
    ...
    $(document).ready(function () {
        $('#goRelated').on('click', function () { LoadInterview(false) });

        $(&quot;.evidence-buttons&quot;).on('click', toggleReported);

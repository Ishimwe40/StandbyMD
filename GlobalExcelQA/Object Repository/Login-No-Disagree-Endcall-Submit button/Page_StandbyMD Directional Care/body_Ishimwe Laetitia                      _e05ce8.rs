...
<WebElementEntity>
   ...
   <name>body_Ishimwe Laetitia                      _e05ce8</name>
   <tag></tag>
   <elementGuidId>a6a81ce0-57ff-4be9-b111-dcfbc8838952</elementGuidId>
   <selectorCollection>
      <entry>
         <key>XPATH</key>
         <value>//body</value>
   ...
   <webElementProperties>
    ...
    $('#patientImg').tooltipster({
        theme: 'tooltipster-noir'
            ...
            Disclaimer
                                ...
                                The information captured during this call is not intended to be a substitute for professional medical advice, it is provided for the purpose of assisting you in finding medical providers. You assume full responsibility for how you choose to use this information and we do not provide any warranty.If you think that you are having a medical emergency, call 911 or the number for the local emergency ambulance service NOW, or go to the closest emergency department.Always seek the advice of your doctor or other qualified healthcare provider before starting any new treatment, stopping existing treatment or for any questions you may have regarding a medical condition. Nothing contained in this call is intended to be used for medical diagnosis or treatment.
    ...
    $(document).ready(function() {
        ShowAnimation('bodymovin', '/animation/thankyou1.json');

        $('#btnYesEmer').bind('click', ApprovedDisclaimer);
        $('#btnNoEmer').bind('click', ReloadPage);
    ...
    $(document).ready(function () {
        ...
        if (window.appInsights.queue != undefined) {
            window.appInsights.queue.push(function () {
                ...
                var userName = 'qa3@globalexcel.com';
        ...
        UpdateScreenResolution('27748', $height, $width);
